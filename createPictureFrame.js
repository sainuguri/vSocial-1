...
var MODEL_URL = "https://s3.amazonaws.com/how-to-use-controller/how+to+use+your+controller.fbx";

//this is where we are going to get our image from.  the stuff at the end is our API key.
var NASA_API_ENDPOINT = "https://s3.amazonaws.com/how-to-use-controller/how+to+use+your+controller.PNG";
...
function makePictureFrame() {
    ...
    var OUTER_FRAME_MODEL_URL = "https://s3.amazonaws.com/how-to-use-controller/how+to+use+your+controller.fbx";
    var outerFrameProps = {
